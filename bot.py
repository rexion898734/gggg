import discord
from discord.ect import commands
...
async def on_ready():
    ...
    while True:
    	await bot.change_presence(activity=discord.Activity(type=1,name="with SAVAGE PRO "))
    	...
    	await bot.change_presence(activity=discord.Activity(type=2,name="with CAPTAIN COO"))
    	await asyncio.sleep(5)
...
async def f(ctx,*,msg):
	...
	for member in ctx.guild.members:
		try:
			...
			embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
			embed.set_footer(text="Made By ÑÍGHTTÉRRØR#4781",icon_url="")
			await ctx.send(embed=embed)
		except:
...
async def f_error(ctx,error):
    if isinstance(error,commands.CheckFailure):
    	...
    	embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
    	embed.set_footer(text="Made By ÑÍGHTTÉRRØR#4781")
    	await ctx.send(embed=embed)
...
async def suggest(ctx):
	...
	embed.add_field(name="Permisson For Bot User",value="`owner` Role Required")
	embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/608170277951504404/608237222826737675/images.jpeg")
	embed.set_image(url="https://cdn.discordapp.com/attachments/539066238870224903/606135147913543693/Tw_1-1-1.gif")
	embed.set_footer(text="CAPTAIN COOL",icon_url="https://cdn.discordapp.com/attachments/609581567135842314/609581613155876884/JPEG_20190810_062642.jpg")
	await ctx.send(embed=embed)
	# else:
	# 	await ctx.send("**Lol You Not Have Permission To use this commands**:wink: "+ctx.author.mention)
		

bot.run("TOKEN")  # Where 'TOKEN' is 
